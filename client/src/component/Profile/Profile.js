...
import { Navbar, Nav, Offcanvas, Dropdown ,Card, Table,ListGroup,ListGroupItem} from "react-bootstrap";
import './Profile.scss'
        ...
        <>
               ...
               <div className="content">
                ...
                <Dropdown className="d-inline mx-3 drop-down">
                 ...
                 {/* <div className="content-profile width"> */}
                {!selector.loading &&<div className="contents img"><Card  style={{ width: '20rem' }}>
  <Card.Img  width={180}
