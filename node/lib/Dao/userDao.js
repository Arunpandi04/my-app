...
var userModal_1 = __importDefault(require("../Modal/userModal"));
var userDao = /** @class */ (function () {
    ...
    userDao.prototype.getUser = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    userDao.prototype.findone = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, userModal_1.default.findOne({ email: data })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    userDao.prototype.updateuser = function (id, data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
